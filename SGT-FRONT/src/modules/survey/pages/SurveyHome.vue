...
<template>
  <div class="w-full h-full rounded p-2">
    <div class="w-full h-[20%] mt-5 overflow-y-auto border border-slate-50" id="grafica">
      <ol class="grid grid-cols-3 gap-4 py-4 w-full">
        <li class="bg-secondary p-5">1: ¿Conoce usted los valores que representan la institución Pescalba?</li>
        <li class="bg-secondary p-5">2: Mencione al menos 3 valores.</li>
        <li class="bg-secondary p-5">3: ha visto algun cambio positivo en la operatividad de la empresa ?</li>
        <li class="bg-secondary p-5">4: Si su respuesta es positiva, cuales ha notado ?</li>
        <li class="bg-secondary p-5">5: Que propuestas tendrias para mejorar la operatividad de la empresa ?</li>
